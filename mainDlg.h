...
#include <pjsua-lib/pjsua_internal.h> // Manter esta inclusão se for necessária por MainDlg.h

// REMOVIDO: O BLOCO #pragma comment(lib, "libpjproject-...") foi removido daqui.
...
public:
    ...
    BaloonPopup(CString title, CString message, DWORD flags = NIIF_WARNING);
